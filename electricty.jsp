<html>
	...
	<%
		...
		int i=st.executeUpdate("insert into elc_bill values('"+consumerid+"','"+phone+"','"+amount+"','"+"El_Charge"+"','"+id+"','"+currentDateTime+"')");
 ...
 <body>
 	<div class="details">
 		<center>
 		<h1 style="background-color:orange;color:black;border-radius:5px;width:400px">Electricity Bill</h1>
